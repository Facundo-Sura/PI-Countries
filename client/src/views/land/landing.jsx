...
"
      ...
      <main className={styles.main}>
        <h2>
          Prtoyecto Individual <span className={styles.henry}>Soy Henry</span>
        </h2>
        <Link to="/countries" className={styles.button}>
          <img
          ...
          />
          <h1 className={styles.name}>Countries</h1>
        </Link>
      </main>
      ...
      <footer className={styles.footer}>
        ...
        <p>
          ...
          Powered by{" "}
          <a href="https://portfolio-eta-drab-tlwmc0uxgq.vercel.app/" target="_blanck" className={styles.dev}>
            Facundo sura
          </a>
        </p>
      </footer>
